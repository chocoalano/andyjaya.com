                    ...
                    if($q){
                        if ($tanggal_validasi->format('Y-m-d') === $tanggal_hari_ini->format('Y-m-d')) {
                            if ((int)$data['user_id'] === auth()->id()) {
                                ...
                                Notification::make()
                                    ->title("Anda bukan pengguna yang memiliki otoritas terhadap user yang dipilih, kami menolak bentuk kecurangan yanag anda lakukan!")
                                    ->danger()
                                    ->send();
                            }
                        } else {
                            Notification::make()
                                ->title('Tanggal yang anda pilih tidak sesuai!')
                                ->danger()
                                ->send();
                        }
                    }else{
                        Notification::make()
                                ->title('Anda belum absen masuk pada '.$tanggal_hari_ini)
                                ->danger()
                                ->send();
                    }
                }),
